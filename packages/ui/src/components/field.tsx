...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        // ADR-0014: labels are Space Mono, uppercase, tracked ink — the system's field-label voice.
        "font-mono text-xs font-medium tracking-[0.18em] text-foreground/70 uppercase",
